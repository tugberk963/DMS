...
DMS aims to revolutionize healthcare services by bringing together healthcare service providers (hospitals, health clinics, etc.) and patients on a unified platform. <strong> <h3> For final project, some of main functionalities of DMS built on Rust as back-end canisters. <h3> </strong>
## Project Vision
