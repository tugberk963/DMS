<script>
    ...
    onMount(async () => {
        await get_user_data();
        console.log(userData.health_data.diseases);
    });
</script>
    ...
    <div class="generalContainer">
        ...
        <div class="diseases">
            ...
            <ul class="diseases-list">
                {#if userData.health_data && userData.health_data.diseases && userData.health_data.diseases.length > 0}
                    {#each userData.health_data.diseases as disease}
                        <li>{disease}</li>
                    {/each}
                {:else}
